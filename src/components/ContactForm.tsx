                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground text-lg mb-8">
                            Estamos listos para escucharte y ayudarte a dar el siguiente paso en la evolución digital de tu empresa.
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-card border border-white/10 p-8 rounded-3xl backdrop-blur-sm shadow-2xl shadow-primary/5"
                    >
