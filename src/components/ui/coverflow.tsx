...
items,
  itemWidth = 800,        // Mucho más ancho
  itemHeight = 450,       // Proporción 16:9
  stackSpacing = 150,     // Espacio entre las tarjetas que están en el "stack"
  centerGap = 500,        // Suficiente aire para que no se solapen
  rotation = 45,          // Un ángulo ligeramente menor para que se aprecie más la imagen
  initialIndex = 0,
  enableReflection = true, // Activado por defecto para look premium
...
function CoverFlowItemCard({
  ...
  <img
    src={item.image}
    alt={item.title}
    // w-full h-full y object-cover son vitales aquí
